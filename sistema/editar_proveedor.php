		...
		if(empty($_POST['proveedor']) || empty($_POST['contacto']) || empty($_POST['telefono'])  || empty($_POST['direccion']))
		{
			...
			$direccion    = $_POST['direccion'];
      		...
      		$sql_update = mysqli_query($conection,"UPDATE proveedor
															SET proveedor = '$proveedor', contacto='$contacto',telefono='$telefono',direccion='$direccion'															WHERE codproveedor= $idproveedor ");
	...
	<section id="container">
		...
		<div class="form_register">
			...
			<form action="" method="post">
				...
				<label for="telefono">Telefono del Provvedor</label>
				<input type="number" name="telefono" id="telefono" placeholder="Telefono del Proveedor" value="<?php echo $telefono?>">
